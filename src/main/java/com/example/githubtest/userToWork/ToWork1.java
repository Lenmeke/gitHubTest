...
public class ToWork1 {
    public static void main(String[] args) {
        ...
        PojoTest pojo3 = new PojoTest();
        pojo3.setTest1("C");
        pojo3.setTest2(Arrays.asList("1", "2"));
        ...
        String result = list.stream()
                .flatMap(pojo -> pojo.getTest2().isEmpty() ? Stream.of(String.format("%s|", pojo.getTest1())) : pojo.getTest2().stream()
